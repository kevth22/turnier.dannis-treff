...
<section class="zahlung">  
  ...
  <div class="zahlung-box">  
    ...
    <a href="https://paypal.me/DEINNAME" target="_blank" class="paypal-btn">  
      👉 paypal.me/DEINNAME  
    </a>  
    ...
    <div class="hinweis-zahlung">  
      ...
      <ul>  
        <li>Bitte bei Zahlung Name und Turniertag angeben</li>  
        <li>Anmeldung ist erst nach Zahlung gültig</li>  
        <li>Bei Nichterscheinen keine Rückerstattung</li>  
      </ul>  
    </div>  
...
<script>  
  const checkbox = document.getElementById("datenschutzCheck");  
